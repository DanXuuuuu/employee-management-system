                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12 md:col-span-8 space-y-6">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex flex-wrap items-center gap-4">
                                            <label
                                                className={`flex items-center gap-2 text-sm ${isReadOnly ? "text-slate-400" : "text-slate-700"
                                                    }`}
                                            >
                                                <input
                                                    type="radio"
                                        ...
                                        <div className="text-xs text-slate-500">
                                            If you select <span className="font-semibold">No</span>, please provide
                                            your work authorization details below.
                                        </div>
                                    </div>
                                        ...
                                        <div className="rounded-xl border border-slate-200 bg-white p-4">
                                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                ...
                                                <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
                                                    Work authorization documents are not required for citizens or
                                                    permanent residents.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {!citizenYes && (() => {
                                        ...
                                        const needsWorkAuthDoc =
                                            visaType === "H1-B" || visaType === "L2" || visaType === "H4" || visaType === "Other"; // ✅ non-F1 -> Work Auth
                        ...
                        {active === "refEmergency" && (
                            ...
                            >
                                <div className="space-y-6">
                                    {/* ---------- Reference (optional in schema, but we build UI anyway) ---------- */}
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                        <div className="flex items-center justify-between">
                                            <div className="text-sm font-semibold text-slate-900">Reference</div>
                                            {isReadOnly && <Badge variant="default">Read-only</Badge>}
                                        </div>
                                        ...
                                        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), firstName: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), lastName: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), middleName: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), phone: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), email: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                            <TextField
                                                ...
                                                onChange={(e) =>
                                                    dispatch(setField({ name: "reference", value: { ...(form.reference || {}), relationship: e.target.value } }))
                                                }
                                                readOnly={isReadOnly}
                                            />
                                        </div>
                            ...
                            <Card title="Documents & Summary" right={<Badge variant="default">Redux</Badge>}>
                                ...
                                <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    {(() => {
                                        ...
                                        const needsWorkAuthDoc =
                                            !citizenYes && (visaType === "H1-B" || visaType === "L2" || visaType === "H4" || visaType === "Other");
